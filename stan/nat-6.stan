...
model {
	...
	/* Nearly there. The key observable, `votes`, is assumed to come from
	   ...
	   the overall party preference proportions `alpha`, plus the
	   pollster's estimated party biases `beta`, as well as a multiplying
	   date effect `day`.
